 ...
 *  - 클라이언트가 요청(Request)하는 내용을 서버에서 처리하고 응담(Response)을 클라이언트로 보낸다.
 *  
 *  IP 주소
...
public class InetAddressTest 
{
	public static void main(String[] args)
	{
		...
		try {
			...
			System.out.println("google의 호스트 이름 : "+ ip.getHostName());
			System.out.println("google의 IP주소 : " + ip.getHostAddress());
