...
public class Application {//메인 실행 클래스(객체 생성 및 테스트)
	 ...
	 *  
	 * 객체기향 프로그래밍(OOP, Objected-Oriented Programming)
	 *  	- 개발하는 방법을 여러 개의 "객체"로 나누어 각 객체마다 각자의 역할을 가지도록 구성
	 *  	- 코드에 재사용성이 높고, 유지보수가 용이하고, 확장성이 뛰어남.
	 * OOP 특징
	 * 1. 추상화(Abstraction)
	 * 2. 캡슐화(Encapsulation)
	 * 3. 상속(Inheritance)
	 ...
	 * O : OCP(Open / Closed Principle) - 캐방 폐쇄 원칙
	...
	public static void main(String[] args) 
	{
		...
		// 객체의 주소값을 참ㅈ 타입의 변수에 저장해서 객체 사용
		
		//객체 생성 = 메모리에 올린다 = 객체의 구성요소(field, method)가 다 올라간다.
		Tv tv = new Tv();
		System.out.println("TV 상태 : "+tv.power);// 꺼진 상태
		tv.power();// 켜기
		System.out.println("TV 채널 : "+ tv.channel);//채널 상태
		tv.channelUp();
		tv.channelUp();
		tv.channelUp();
		System.out.println("TV 상태 : "+tv.power);// 킨 상태
		System.out.println("TV 채널 : "+ tv.channel);//채널 상태
	}
