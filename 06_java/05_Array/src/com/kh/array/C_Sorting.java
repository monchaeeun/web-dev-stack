...
public class C_Sorting {
	...
	public void method1() {
		...
		// 2. 내림차순 정렬(큰 숫자부터 작은 숫자)
		// -> 원본 배열을 따로 있고 새로운 배열 생성
	...
	/*
	 * 삽입 정렬(Insertion Sort) - 정렬 알고리즘에서 가장 기본이 되는 알고리즘 - 필요할 때만 위치를 바꾸므로 이미 데이터가 거의
	 * 정렬되었을 때 효율적
	 */
	public void method5() {
		int[] arr = { 7, 5, 9, 0, 3, 1, 6, 2, 4, 8 };
