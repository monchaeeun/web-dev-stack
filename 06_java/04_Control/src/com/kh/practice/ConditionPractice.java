...
//		c.method9();
	...
	public void method3() {
		...
		System.out.println("합계 : " + String.format("%.0f", sum));
		System.out.println("평균 : " + String.format("%.1f", result));
	...
	public void method4() {
		System.out.print("구매한 옷 가격을 입력하세요 : ");
		double a = sc.nextDouble();
		double result = a;
		if (a >= 500000) {
			result = (a * (1 - 0.2));
		...
		System.out.println(df.format(a) + "원 입니다");
	}
	...
	public void method9() {
		...
		while (true) {
			...
			if (a == 1) {
				...
				System.out.println("조회 메뉴입니다 : " + menu);
			} else if (a == 4) {
	...
	public void method10() {
		...
		double total = are + bre + cre + dre;
		System.out.println("===========결과========== ");
		System.out.println("중간 고사 점수(20) :" + String.format("%.1f", are));
		System.out.println("기말 고사 점수(30) :" + String.format("%.1f", bre));
		System.out.println("과제 점수(30) :" + String.format("%.1f", cre));
		System.out.println("출석 횟수(20) :" + String.format("%.1f", dre));
		if (dre >= 14 && total >= 70) {
			System.out.println("총점 :" + String.format("%.1f", total) + " PASS");
		}
		if (dre <= 14) {
			System.out.println("FAIL [출석 횟수 부족] (" + dre + "/20)");
		}
		if (total < 70) {
			System.out.println("FAIL [점수 미달] (총점 " + String.format("%.1f",total) + ")");
		}
