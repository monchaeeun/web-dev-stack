/*
 * 자바의 특징
  1. 객체 지향 프로그래밍(Object-Oriented Programming, OOP) 언어
	  -> 모든 기능을 "객체" 라는 단위로 구성
	  -캡슐화, 상속, 다형성, 추상화
  ...
  6. 멀티 스레드 지원(Java API)
  	 ...
  	 *자바 프로그램 실행 단계*
  	 ...
  	 2. 작성된 소스파일을 컴파일러(javac.exe)로 컴파일하여
  	 	확장자가 .class인 바이트코드(기계어)로 번역한다.
  	 3. 번역된 바이트코드(기계어)를 JVM의 자바 인터프린터(java.exe)를 이용해 실행한다.	
...
/*
	* 클래스(class)
	...
	- 클래슨는 설계도이며, 이를 바탕으로 객체(인스틴스)를 생성해 사용한다.
...
{ 
	...
	*/
	...
	public static void main(String[] args) 
	{
		...
		/*  
		  네이밍 규칙
		  -패키지명 : 소문자로 작성, 회사들간의 패키지가 서로 중복되지 않도록
