...
public class Application {
	/*
	 * 랑다식(Lambda Expression) => 자바 스크립트의 화살표 함수!
	 * - 자바에서 함수적 프로그래밍을 위해서 자바 8 부터 람다식 지원
	 * - 람다식은 매개변수를 가지는 함수와 같은 코드 블록이지만
	 * 				련타임시 인터페이스 익명 구현 객체 생성
	 * - 람다식을 사용하면 코드가 간결해지고,
