...
public class Application {
	...
	{	// 추상 클래스여서 객체 생성 x
		...
		System.out.println();
		System.out.println("----------------------------------");
		//Pizza bulPizza = new BulgogiPizza(7900, "도미노");
		
		Pizza bulPizza = new BulgogiPizza(7900, "도미노");
		Pizza pinPizza = new PineapplePizza(8800, "피자헛");
		Pizza poPizza = new PotatoPizza(7000, "파파존스");
		
		Pizza[] pizza = {bulPizza,pinPizza,poPizza};
