...
(
    ...
    TRANS_AMOUNT INT ,
    TRANS_DESC TEXT NOT NULL, -- 지출 수익 내역
    TRANS_DATE DATE NOT NULL, -- 지출 날짜
    USER_NO INT
);
...
(
	...
	STATUS VARCHAR(20) CHECK(STATUS IN('통과','불량','조치필요')),
	USER_NO INT
);
-- 불량품 관리
