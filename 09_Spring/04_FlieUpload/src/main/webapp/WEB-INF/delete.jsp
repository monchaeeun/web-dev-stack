...
<body>
	...
	<div class="container">
		<!--<form action="/update" method="post" enctype ="multipart/form-data">-->
			<h3>상세 정보</h3>
			<button type="button" name="back" id="back" class="btn btn-outline-secondary btn-sm back-btn">돌아가기</button>
			<img class="preview-img" src="http://192.168.0.35:8081/${board.url}"/>
			
			<input type="hidden" name="no" id="no" value="${board.no}">
			<input type="hidden" name="url" id="url" placeholder="${board.url}">
			<p>제목</p>
			...
			<input class="form-control" name="file" type="file" id="file" accept="image/*" disabled><br><br>
			...
			<div class="button-group">
				...
				<a id="delete" href="/delete?no=${board.no}">삭제</a>
			</div>
		<!--</form>-->
	</div>			
	<script>
